<?php
$pageTitle = "Terms and Conditions | BS Digital Solutions";
$pageDescription = "";
$pageKeywords = "";
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="port-details-content">
                        <h3>DISCLAIMER</h3>
                        <p>The information provided by BS Digital Solutions ("Company", "we", "our", "us") on BS Digital
                            Solutions.com (the
                        ...
                        <p>UNDER NO CIRCUMSTANCE SHALL WE HAVE ANY LIABILITY TO YOU FOR ANY LOSS OR DAMAGE OF ANY KIND
                            ...
                            SITE. YOUR USE OF THE SITE AND YOUR RELIANCE ON ANY INFORMATION ON THE SITE IS SOLELY AT
                            YOUR OWN RISK.</p>
                        <h3>EXTERNAL LINKS DISCLAIMER</h3>
                        <p>The Site may contain (or you may be sent through the Site) links to other websites or content
                            belonging to or originating from third parties, or links to websites and features. Such
                            external links are not investigated, monitored, or checked for accuracy, adequacy, validity,
                            reliability, availability, or completeness by us.</p>
                        <p>WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR THE ACCURACY OR
                        ...
                        <p>The Site may contain links to affiliate websites, and we may receive an affiliate commission
                        ...
                        <p>The Site may contain testimonials by users of our products and/or services. These
                            ...
                            experiences are personal to those particular users and may not necessarily be representative
                            of all users of our products and/or services. We do not claim, and you should not assume
                            that all users will have the same experiences.</p>
                        <p>YOUR INDIVIDUAL RESULTS MAY VARY.</p>
                        <p>The testimonials on the Site are submitted in various forms such as text, audio, and/or
                        ...
                        <p>The views and opinions contained in the testimonials belong solely to the individual user and
                            do not reflect our views and opinions.</p>
                        <h3>ERRORS AND OMISSIONS DISCLAIMER</h3>
                        <p>While we have made every attempt to ensure that the information contained in this site has
                            been obtained from reliable sources, BS Digital Solutions is not responsible for any errors
                            or
                            omissions or for the results obtained from the use of this information. All information on
                            this site is provided "as is", with no guarantee of completeness, accuracy, timeliness, or
                            of the results obtained from the use of this information, and without warranty of any kind,
                            express or implied, including, but not limited to warranties of performance,
                            merchantability, and fitness for a particular purpose.</p>
                        <p>In no event will BS Digital Solutions, its related partnerships or corporations, or the
                            partners,
                            agents, or employees thereof be liable to you or anyone else for any decision made or action
                            taken in reliance on the information in this Site or for any consequential, special, or
                            similar damages, even if advised of the possibility of such damages.</p>
                        <h3>GUEST CONTRIBUTORS DISCLAIMER</h3>
                        <p>This Site may include content from guest contributors, and any views or opinions expressed in
                            such posts are personal and do not represent those of BS Digital Solutions or any of its
                            staff or
                        ...
                        <p>All logos and trademarks of third parties referenced on bs-digital-solutions.com are the
                            ...
                            owners.</p>
                        <h3>CONTACT US</h3>
                        <p>Should you have any feedback, comments, requests for technical support, or other inquiries,
                            please contact us by email: <strong><a href="mailto:bidhans1990@gmail.com.php">sales@BS
                                    Digital
                                    Solutions.com</a></strong></p>
                    </div>
                </div>
            </div>
        </div>
