...
<?php include 'components/services-index.php'; ?>

<section class="snd_full_banner_sec" style="margin-bottom:100px; padding-top:100px" id="fst-banner-full">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 data-aos="fade-up" data-aos-duration="1000" class="section-title mb-5"
                    data-content-key="home.amplify_headline">Why choose us as your
                    strategic growth <span>partner</span>, a <span>360&deg; global</span> branding agency?</h1>
                <div data-aos="fade-up" data-aos-duration="1000" class="section-title"
                    data-content-key="home.amplify_body">We transform
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="testi-heading text-center">
                    ...
                    <a data-link-key="blogs" href="blogs.php" class="right-viewbtn"><i
            ...
            <div class="col-lg-6">
                <div class="blog-area">
                    <a href="blog-details/blog-details-how-to-choose-the-best-branding-agency-in-mumbai-a-complete-guide-for-growing-businesses.php">
                        ...
                        <div class="blog-content">
                            ...
                            <div class="case-study">
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="8" height="13"
                                        ...
                                        <path d="M1 1.5L6 6.5L1 11.5" stroke="var(--icon-color)" stroke-width="2">
                                        </path>
                                    </svg></span>
                                read more
                            </div>
            ...
            <div class="col-lg-6">
                <div class="blog-area">
                    <a href="blog-details/blog-details-do-you-know-what-makes-digiBrandX-a-top-10-branding-agency-in-mumbai-for-business-success.php">
                        <div class="blog-img"><img
                                src="upload/news/p1nae08evs6opiutg2or3ss484_BediBrandX.brandingagencyimMumbai01.webp"
                                alt="BS Digital Solution" class="img-fluid"></div>
                        <div class="blog-content">
                            <h5>What makes BS Digital Solution stand among the top 10 advertising agencies in Mumbai for driving real business success?</h5>
            ...
            <div class="accordion-item open">
                ...
                <div class="accordion-panel">
                    <div class="panel-inner">
                        <div><span>BS Digital Solution is a
                                <strong>full-service creative agency </strong>specializing in
                                ...
                                creative content production, including brand films and corporate films, BS Digital Solution
                ...
                <div class="accordion-panel">
                    <div class="panel-inner">
                        <p>A professional branding agency measures success using clear performance indicators,
                            ...
                            sentiment. We track how your brand's perception evolves over time and its impact on business growth.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="client-heading" data-aos="fade-up" data-aos-duration="1000">
                    <div class="section-title">Case Study</div> <a href="case-study.php" class="right-viewbtn"><i
                            class="fas fa-angle-right"></i> View All</a>
                </div>
            </div>
            <div class="case-study-slider owl-carousel mt-5">
                <div class="cs-item" data-aos="fade-up" data-aos-duration="1000">
                    <a href="case-study-details/case-study-details-Ollato-Mental-Health-Wellness-Brand-Case-Study.php">
                        <div class="cs-img">
                            <img src="upload/case_study/858f62339599ef73111b11e2f3d6f7f6_fl.webp" class="img-fluid" alt="Ollato">
                        </div>
                        <div class="cs-text">
                            <h3>Ollato</h3>
                            <p>Mental Health & Wellness Brand</p>
                        </div>
                    </a>
                </div>
            </div>
