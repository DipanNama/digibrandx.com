        ...
        <div class="col-lg-12">
          <div class="port-details-content">
            ...
            <p>The Site may contain testimonials by users of our products and/or services. These testimonials reflect
              ...
              We do not claim, and you should not assume that all users will have the same experiences.</p>
            ...
            <p>While we have made every attempt to ensure that the information contained in this site has been obtained
              from reliable sources, BS Digital Solutions is not responsible for any errors or omissions or for the
              results
            ...
            <p>In no event will BS Digital Solutions, its related partnerships or corporations, or the partners, agents,
              or
            ...
            <p>This Site may include content from guest contributors, and any views or opinions expressed in such posts
              are personal and do not represent those of BS Digital Solutions or any of its staff or affiliates unless
              explicitly
              stated.</p>
            <h3>LOGOS AND TRADEMARKS DISCLAIMER</h3>
            <p>All logos and trademarks of third parties referenced on bs-digital-solutions.com are the trademarks and
              logos of
              their respective owners. Any inclusion of such trademarks or logos does not imply or constitute any
              approval, endorsement, or sponsorship of BS Digital Solutions by such owners.</p>
            <h3>CONTACT US</h3>
            <p>Should you have any feedback, comments, requests for technical support, or other inquiries, please
              contact us by email: <strong><a href="mailto:bidhans1990@gmail.com.php">sales@BS Digital
                  Solutions.com</a></strong>
            </p>
          </div>
        </div>
      </div>
